...
export function Navbar() {
  return (
    <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4 w-full">
      <nav className="flex items-center justify-between w-full max-w-5xl px-8 py-4 glass-button rounded-full">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Button variant="solid" className="text-xs uppercase tracking-widest px-6 py-2 rounded-full">
